...
public partial class SpxmlObjects
{
    ...
    public virtual AbsenceReserve? AbsenceReserve { get; set; }
    ...
    public virtual BenefitProfile? BenefitProfile { get; set; }

    public virtual BlockMessage? BlockMessage { get; set; }
    ...
    public virtual CareerPlan? CareerPlan { get; set; }
    ...
    public virtual ChannelProvider? ChannelProvider { get; set; }
    ...
    public virtual CheckSchedule? CheckSchedule { get; set; }
    ...
    public virtual ClVideoCourse? ClVideoCourse { get; set; }

    public virtual ClassificationModel? ClassificationModel { get; set; }

    public virtual ClosingDocument? ClosingDocument { get; set; }

    public virtual ClosingDocumentStatus? ClosingDocumentStatus { get; set; }

    public virtual CodeLibrary? CodeLibrary { get; set; }
    ...
    public virtual EducationMode? EducationMode { get; set; }
    ...
    public virtual EfficiencyGrade? EfficiencyGrade { get; set; }
    ...
    public virtual FactPayment? FactPayment { get; set; }
    ...
    public virtual IntervalSchedule? IntervalSchedule { get; set; }
    ...
    public virtual KnowledgeAcquaint? KnowledgeAcquaint { get; set; }
    ...
    public virtual KpiPlan? KpiPlan { get; set; }
    ...
    public virtual ObjectClaim? ObjectClaim { get; set; }

    public virtual ObjectData? ObjectData { get; set; }

    public virtual ObjectDataType? ObjectDataType { get; set; }

    public virtual ObjectLink? ObjectLink { get; set; }

    public virtual ObjectParam? ObjectParam { get; set; }
    ...
    public virtual PersonalAssistant? PersonalAssistant { get; set; }

    public virtual PersonalDataProcessingConsent? PersonalDataProcessingConsent { get; set; }

    public virtual PersonnelCommittee? PersonnelCommittee { get; set; }

    public virtual PersonnelDocument? PersonnelDocument { get; set; }

    public virtual PersonnelDocumentType? PersonnelDocumentType { get; set; }
    ...
    public virtual PotentialGrade? PotentialGrade { get; set; }
    ...
    public virtual ProfessionalAreaType? ProfessionalAreaType { get; set; }
    ...
    public virtual ProjectParticipantRole? ProjectParticipantRole { get; set; }

    public virtual ProjectType? ProjectType { get; set; }

    public virtual Provider? Provider { get; set; }

    public virtual ProviderCourseType? ProviderCourseType { get; set; }

    public virtual QaTest? QaTest { get; set; }

    public virtual QaTestParamset? QaTestParamset { get; set; }

    public virtual QaTestResult? QaTestResult { get; set; }

    public virtual QaTestSet? QaTestSet { get; set; }
    ...
    public virtual RecommenderAlgorithm? RecommenderAlgorithm { get; set; }

    public virtual RecommenderAlgorithmApplying? RecommenderAlgorithmApplying { get; set; }

    public virtual RecommenderSelectCollaborator? RecommenderSelectCollaborator { get; set; }

    public virtual RecruitmentEvent? RecruitmentEvent { get; set; }

    public virtual RecruitmentMethod? RecruitmentMethod { get; set; }

    public virtual RecruitmentPlan? RecruitmentPlan { get; set; }

    public virtual RecruitmentSystem? RecruitmentSystem { get; set; }

    public virtual Region? Region { get; set; }

    public virtual RemoteAction? RemoteAction { get; set; }

    public virtual RemoteApplication? RemoteApplication { get; set; }
    ...
    public virtual RestrictingCollaboratorSchedule? RestrictingCollaboratorSchedule { get; set; }

    public virtual RestrictingType? RestrictingType { get; set; }
    ...
    public virtual SalaryPaymentType? SalaryPaymentType { get; set; }
    ...
    public virtual SaleContractType? SaleContractType { get; set; }
    ...
    public virtual StaffPositionFinish? StaffPositionFinish { get; set; }

    public virtual StaffPositionMove? StaffPositionMove { get; set; }

    public virtual StaffPositionStart? StaffPositionStart { get; set; }

    public virtual Statement? Statement { get; set; }

    public virtual StatementActor? StatementActor { get; set; }

    public virtual StatementAdditional? StatementAdditional { get; set; }

    public virtual StatementAttachment? StatementAttachment { get; set; }

    public virtual StatementComponent? StatementComponent { get; set; }

    public virtual StatementObject? StatementObject { get; set; }

    public virtual StatementPattern? StatementPattern { get; set; }
    ...
    public virtual SystemEventHandler? SystemEventHandler { get; set; }
    ...
    public virtual UiData? UiData { get; set; }
    ...
    public virtual UserRecommendation? UserRecommendation { get; set; }
    ...
    public virtual VclassSetting? VclassSetting { get; set; }

    public virtual VendorState? VendorState { get; set; }

    public virtual Verb? Verb { get; set; }

    public virtual ViewConfiguration? ViewConfiguration { get; set; }

    public virtual WageSystem? WageSystem { get; set; }

    public virtual Walkthrough? Walkthrough { get; set; }

    public virtual WebDesign? WebDesign { get; set; }

    public virtual WebMode? WebMode { get; set; }

    public virtual WebPersonState? WebPersonState { get; set; }
    ...
    public virtual WorkCondition? WorkCondition { get; set; }
    ...
    public virtual WorkingConditionType? WorkingConditionType { get; set; }

    public virtual WorkspaceConfig? WorkspaceConfig { get; set; }
}
